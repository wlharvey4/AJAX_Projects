...
The following code creates a project directory ~AJAX_Projects~ into which all
of the projects from this course will be installed.  It installs into that
project directory Yarn v2, initializes a new project, and then installs as a
development dependency the ~npm~ package ~liveServer~ from:
- https://www.npmjs.com/package/live-server

#+CAPTION: Installation of liveServer
#+NAME: liveServer-install
#+HEADER: :results silent :exports results
#+HEADER: :dir AJAX_Projects :mkdirp yes
#+begin_src shell
